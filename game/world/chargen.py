...
# from enums import ItemType, BondedStatus
# from .random_tables import chargen_tables
# from .rules import dice

MY_ATTRIBUTES = ["strength", "endurance",
                 "coordination", "quickness", "focus", "willpower"]


MAX_ATTRIBUTE_CREDITS = 270
...
class TemporaryCharacterSheet:
    ...
    def __init__(self):
        ...
        self.attribute_credits = MAX_ATTRIBUTE_CREDITS

        for attrib in MY_ATTRIBUTES:
            setattr(self, attrib, MIN_ATTRIBUTE_VALUE)
    ...
    def apply(self, account):
        ...
        new_character = create_object(
            ...
            # attributes=(
            #     ("_attributes", {
            #         "strength": {"innate": self.strength, "invested": 0},
            #         "endurance": {"innate": self.endurance, "invested": 0},
            #         "coordination": {"innate": self.coordination, "invested": 0},
            #         "quickness": {"innate": self.quickness, "invested": 0},
            #         "focus": {"innate": self.focus, "invested": 0},
            #         "willpower": {"innate": self.willpower, "invested": 0},
            #     }, "primary_attributes"),
            # ),
        )


        sack = spawn('wcid_166')[0]
        calling_stone = spawn('wcid_5084')[0]

        # # CREATE STARTING EQUIPMENT HERE

        #backpack.location = new_character
        sack.location = new_character
        calling_stone.location = new_character

        # new_character.inventory._save()


        # SET STARTING ATTRIBUTE SCORES HERE
...
def _update_name(caller, raw_string, **kwargs):
    ...
    # Check for existing names or name banlist
