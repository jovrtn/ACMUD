...
class Command(BaseCommand):
    ...
    def at_post_cmd(self):
        ...
        caller = self.caller        
        prompt = f"|x<|n|r{caller.vitals.health.current}|n|R/{caller.vitals.health.max}h|n |y{caller.vitals.stamina.current}|n|Y/{caller.vitals.stamina.max}s|n |b{caller.vitals.mana.current}|n|B/{caller.vitals.mana.max}m|n|x>|n"
